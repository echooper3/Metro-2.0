...
export const CITIES: City[] = [
  {
    ...
    name: 'Tulsa',
    state: 'Oklahoma',
    image: 'https://images.unsplash.com/photo-1599427404423-69032f913693?auto=format&fit=crop&q=80&w=800',
...
export const CATEGORIES: Category[] = [
  'All', 'Trending', 'Sports', 'Family Activities', 'Entertainment', 'Visitor Activities', 'Food & Drink', 'Night Life', 'Arts & Culture', 'Outdoors', 'Community'
];
